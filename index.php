...
<body>
    ...
    <h4>
        Essa é uma variável do tipo números/interger
        para implementar essa variávelmos somente os
        números desta forma
        :
        <?php
        echo $numeros;
    ...
    <h4>
        ...
        um array em uma variável utilizamos desta forma :
          ...
          ?>  
          <h4>
            Vamos agora implementar uma variáveç do tipo datas,
            para implementar a variável com datas utilizamos uma função 
            própria do php desta forma :
            <?php
            print $data;
            ?>
